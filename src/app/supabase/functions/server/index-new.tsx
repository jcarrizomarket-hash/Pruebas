...
app.get('/make-server-ce05fe95/clientes', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/clientes', requireSecret, async (c) => {
  try {
...
app.put('/make-server-ce05fe95/clientes/:id', requireSecret, async (c) => {
  try {
...
app.delete('/make-server-ce05fe95/clientes/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-ce05fe95/clientes/:id/contacto', async (c) => {
  try {
    const id = c.req.param('id');
    const cliente = await db.obtenerClientePorId(supabase, id);
    if (!cliente) {
      return c.json({ success: false, error: 'Cliente no encontrado' }, 404);
    }
    return c.json({ success: true, data: cliente });
  } catch (error) {
    console.error('Error al obtener contacto del cliente:', error);
    return c.json({ success: false, error: String(error) }, 500);
  }
});
...
app.get('/make-server-ce05fe95/camareros', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/camareros', requireSecret, async (c) => {
  try {
    const datos = await c.req.json();
...
app.put('/make-server-ce05fe95/camareros/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
    const datos = await c.req.json();
...
app.delete('/make-server-ce05fe95/camareros/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-ce05fe95/coordinadores', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/coordinadores', requireSecret, async (c) => {
  try {
    const datos = await c.req.json();
...
app.put('/make-server-ce05fe95/coordinadores/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
    const datos = await c.req.json();
...
app.delete('/make-server-ce05fe95/coordinadores/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-ce05fe95/pedidos', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/pedidos', requireSecret, async (c) => {
  try {
    const datos = await c.req.json();
...
app.put('/make-server-ce05fe95/pedidos/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
    const datos = await c.req.json();
...
app.delete('/make-server-ce05fe95/pedidos/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-ce05fe95/asignaciones', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/asignaciones', requireSecret, async (c) => {
  try {
    const datos = await c.req.json();
...
app.put('/make-server-ce05fe95/asignaciones/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
    const datos = await c.req.json();
...
app.delete('/make-server-ce05fe95/asignaciones/:pedidoId/:camareroCodigo', requireSecret, async (c) => {
  try {
...
app.get('/make-server-ce05fe95/usuarios', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/usuarios', requireSecret, async (c) => {
  try {
    const datos = await c.req.json();
...
app.post('/make-server-ce05fe95/login', async (c) => {
  try {
...
app.put('/make-server-ce05fe95/usuarios/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
    const datos = await c.req.json();
...
app.delete('/make-server-ce05fe95/usuarios/:id', requireSecret, async (c) => {
  try {
    const id = c.req.param('id');
...
app.post('/make-server-ce05fe95/pedidos/:id/qr-token', requireSecret, async (c) => {
  try {
...
app.get('/make-server-ce05fe95/qr-scan/:token', async (c) => {
  try {
...
app.post('/make-server-ce05fe95/qr-scan/:token/registrar', async (c) => {
  try {
    const token = c.req.param('token');
...
app.get('/make-server-ce05fe95/registros-asistencia', async (c) => {
  try {
    const pedidoId = c.req.query('pedidoId');
...
app.get('/make-server-ce05fe95/registros-perfil', async (c) => {
  try {
...
app.get('/make-server-ce05fe95/health', (c) => {
  return c.json({ 
    success: true, 
